...
class Rto(RtoQtyQty):
    ...
    automatically cancelled out.  RTO supports titers (e.g., "1:128")
    and other quantities produced by laboratories that truly represent
    ...
    cases REAL should be used instead of RTO.
    """
